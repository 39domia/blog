...
<head>
    ...
    <link href="../cool-admin/vendor/bootstrap-progressbar/bootstrap-progressbar-3.3.4.min.css" rel="stylesheet"
          media="all">
        ...
        <div class="main-content">
            <div class="section__content section__content--p30">
                <div class="container-fluid">
                    <div class="row pb-4">
                        <div class="col-7">
                            <a href="/author?action=createAuthor"
                               class="au-btn au-btn-icon au-btn--green au-btn--small ml-3">
                                <i class="zmdi zmdi-plus"></i>Add new Category</a>
                        </div>
                        <form class="form-header col-5" action="/author?action=searchAuthor" method="post">
                            <input class="au-input au-input--full" type="text" name="keyWord" placeholder="Enter category name">
                            ...
                            <div class="table-responsive table--no-card m-b-30">
                                <table class="table table-borderless table-striped table-earning">
                                    ...
                                    <c:forEach var="author" items="${authors}">
                                        <tr>
                                            <td><c:out value="${author.idAuthor}"></c:out></td>
                                            <td><c:out value="${author.authorName}"></c:out></td>
                                            <td style="max-width: 500px"><c:out value="${author.authorDes}"></c:out></td>
                                            <td>
                                                <div class="table-data-feature">
                                                    <a href="/author?action=editAuthor&id=${author.idAuthor}"
                                                       class="item" data-toggle="tooltip" data-placement="top" title=""
                                                       data-original-title="Edit">
                                                        <i class="zmdi zmdi-edit"></i>
                                                    </a>
                                                    <a class="btn btn-secondary mb-1" href="/author?action=deleteAuthor&id=${author.idAuthor}"
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button  type="button" class="btn btn-primary">
                            <%--                            <a href="/category?action=deleteAuthor&id=${categories.idCategory}">Confirm</a>--%>
                        </button>
                    </div>
                </div>
            </div>
