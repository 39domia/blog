        ...
        <div class="main-content">
            <div class="section__content section__content--p30">
                <div class="container-fluid">
                    <div class="row pb-4">
                        <div class="col-7">
                            <a href="/category?action=createCategory"
                               class="au-btn au-btn-icon au-btn--green au-btn--small ml-3">
                                <i class="zmdi zmdi-plus"></i>Add new Category</a>
                        </div>
                        <form class="form-header col-5" action="" method="POST">
                            <input class="au-input au-input--full" type="text" name="search" placeholder="Enter category name">
                            ...
                            <div class="table-responsive table--no-card m-b-30">
                                <table class="table table-borderless table-striped table-earning">
                                    ...
                                    <c:forEach var="category" items="${categories}">
                                        <tr>
                                            <td><c:out value="${category.idCategory}"></c:out></td>
                                            <td><c:out value="${category.categoryName}"></c:out></td>
                                            <td>
                                                <div class="table-data-feature">
                                                    <a href="/category?action=editCategory&id=${category.idCategory}"
                                                       class="item" data-toggle="tooltip" data-placement="top" title=""
                                                       data-original-title="Edit">
                                                        <i class="zmdi zmdi-edit"></i>
                                                    </a>
                                                    <a class="btn btn-secondary mb-1" href="/category?action=deleteCategory&id=${category.idCategory}"
