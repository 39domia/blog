                            ...
                            <div class="noti-wrap">
                                ...
                                <div class="noti__item js-item-menu">
                                    ...
                                    <div class="email-dropdown js-dropdown">
                                        ...
                                        <div class="email__item">
                                            <div class="image img-cir img-40">
                                                <img src="../cool-admin/images/icon/avatar-05.jpg"
                                                     alt="Cynthia Harvey"/>
                                            </div>
                                            <div class="content">
                                                <p>Meeting about new dashboard...</p>
                                        ...
                                        <div class="email__item">
                                            <div class="image img-cir img-40">
                                                <img src="../cool-admin/images/icon/avatar-04.jpg"
                                                     alt="Cynthia Harvey"/>
                                            </div>
                                            <div class="content">
                                                <p>Meeting about new dashboard...</p>
        ...
        <div class="main-content">
            <div class="section__content section__content--p30">
                <div class="container-fluid">
                    <div class="row pb-4">
                        <div class="col-7">
                            <a href="/post?action=createPost"
                               class="au-btn au-btn-icon au-btn--green au-btn--small ml-3">
                                <i class="zmdi zmdi-plus"></i>Add new Post</a>
                        </div>
                        <form class="form-header col-5" action="/post?action=searchPost" method="POST">
                                ...
                                <table class="table table-borderless table-striped table-earning">
                                    ...
                                    <c:forEach var="post" items="${posts}">
                                        <tr>
                                            ...
                                            <td>${post.category.getCategoryName()}</td>
                                            <td>${post.author.getAuthorName()}</td>
                                            <td>
                                                <div class="table-data-feature">
                                                    <a href="/post?action=editPost&id=${post.idPost}"
                                                       class="item" data-toggle="tooltip" data-placement="top" title=""
                                                       data-original-title="Edit">
                                                        <i class="zmdi zmdi-edit"></i>
                                                    </a>
                                                    <a class="btn btn-secondary mb-1"
                                                       href="/post?action=deletePost&id=${post.idPost}"
