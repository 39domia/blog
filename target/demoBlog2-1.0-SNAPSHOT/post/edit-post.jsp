                        ...
                        <div class="col">
                            <div class="card">
                                ...
                                <div class="card-body card-block">
                                    <form method="post" action="/post?action=editPost"class="form-horizontal">
                                        <input type="hidden" value="${post.idPost}" name="id">
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                                <label for="postTitle" class=" form-control-label">Post title</label>
                                            </div>
                                            <div class="col-12 col-md-9">
                                                <input type="text" id="postTitle" name="postTitle"
                                                       class="form-control" value="${post.postTitle}">
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <input type="text" id="image" name="image"
                                                       class="form-control" value="${post.image}">
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            <div class="col col-md-3">
