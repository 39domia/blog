                                ...
                                <table class="table table-borderless table-striped table-earning">
                                    ...
                                    <c:forEach var="category" items="${categories}">
                                        <tr>
                                            ...
                                            <td><c:out value="${category.des}"></c:out></td>
                                            <td>
                                                <div class="table-data-feature">
                                                    <a href="/category?action=editCategory&id=${category.id}"
                                                       class="item" data-toggle="tooltip" data-placement="top" title=""
                                                       data-original-title="Edit">
                                                        <i class="zmdi zmdi-edit"></i>
                                                    </a>
                                                    <a class="btn btn-secondary mb-1" href="/category?action=deleteCategory&id=${category.id}"
