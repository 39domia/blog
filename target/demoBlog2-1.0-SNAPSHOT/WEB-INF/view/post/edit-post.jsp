                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <textarea name="shortContent" id="shortContent" rows="4"
                                                          class="form-control" required>${post.shortContent}</textarea>
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <textarea name="fullContent" id="summernote" rows="9"
                                                          class="form-control" required>${post.fullContent}</textarea>
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <input type="text" id="image" name="image"
                                                       class="form-control" value="${post.image}" required>
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            <div class="col col-md-3">
