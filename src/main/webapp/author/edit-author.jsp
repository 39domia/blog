...
<head>
    ...
    <link href="${pageContext.request.contextPath}cool-admin/vendor/css-hamburgers/hamburgers.min.css" rel="stylesheet"
          media="all">
                                    ...
                                    <div class="mess-dropdown js-dropdown">
                                        ...
                                        <div class="mess__item">
                                            <div class="image img-cir img-40">
                                                <img src="../cool-admin/images/icon/avatar-06.jpg"
                                                     alt="Michelle Moreno">
                                            </div>
                                            <div class="content">
                        ...
                        <div class="col">
                            <div class="card">
                                ...
                                <div class="card-body card-block">
                                    <form method="post" action="/author?action=editAuthor" class="form-horizontal">
                                        <input type="hidden" value="${author.idAuthor}" name="id">
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                                <label for="authorName" class=" form-control-label">author name</label>
                                            </div>
                                            <div class="col-12 col-md-9">
                                                <input type="text" id="authorName" name="authorName"
                                                       value="${author.authorName}" class="form-control">
                                        ...
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                                <label for="authorDes" class=" form-control-label">author
                                                    description</label>
                                            </div>
                                            <div class="col-12 col-md-9">
                                                <input type="text" id="authorDes" name="authorDes"
                                                       value="${author.authorDes}" class="form-control">
                                                <small class="form-text text-muted">This is a category name input
                                                    field</small>
                                            </div>
                                        </div>
                                        <div class="card-footer">
                                            ...
                                            <a href="/author" class="btn btn-warning btn-sm">
