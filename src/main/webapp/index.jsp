    ...
    <div class="container logo-wrap">
        <div class="row pt-5">
            <div class="col-12 text-center">
                ...
                <h1 class="site-logo"><a href="/index">Balita</a></h1>
            </div>
        </div>
    </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="post-entry-horzontal">
                            <a href="blog-single.html">
                                <div class="image element-animate" data-animate-effect="fadeIn"
                                     style="background-image: url(${pageContext.request.contextPath}vendor/images/img_10.jpg);"></div>
                                <span class="text">
                      <div class="post-meta">
                      ...
                      <h2>There’s a Cool New Way for Men to Wear Socks and Sandals</h2>
                        ...
                        <div class="post-entry-horzontal">
                            <a href="blog-single.html">
                                <div class="image element-animate" data-animate-effect="fadeIn"
                                     style="background-image: url(${pageContext.request.contextPath}vendor/images/img_11.jpg);"></div>
                                <span class="text">
                      <div class="post-meta">
                      ...
                      <h2>There’s a Cool New Way for Men to Wear Socks and Sandals</h2>
                        ...
                        <div class="post-entry-horzontal">
                            <a href="blog-single.html">
                                <div class="image element-animate" data-animate-effect="fadeIn"
                                     style="background-image: url(${pageContext.request.contextPath}vendor/images/img_12.jpg);"></div>
                                <span class="text">
                      <div class="post-meta">
